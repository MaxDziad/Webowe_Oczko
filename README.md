...
- wchodzimy w Explorer, klikamy w htdocs, usuwamy tam wszystkie domyślne pliki xamppa i wrzucamy całość pobranego projektu
...
Voi la, baza została zaimportowana. Jest jedno domyślne konto do testowania L: admin P: admin123 , możecie też tworzyć ile tam chcecie użytkownik i testować. Good luck!
